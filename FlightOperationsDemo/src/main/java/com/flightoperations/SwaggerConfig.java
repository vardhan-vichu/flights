...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Vishnu Vardhan", "flights.com", "flights@gmail.com");

	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Flights API ", "Flights Api Documentation", "1.0",
